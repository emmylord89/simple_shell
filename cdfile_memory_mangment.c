...
/**
 * myfun_free_all - Free Array Of Char Pointer And Char Pointer
 * @cmd:Array Pointer
 * @line:Char Pointer
 * Return: Void
 */
void myfun_free_all(char **cmd, char *line)
{
free(cmd);
free(line);
cmd = NULL;
...
/**
 * myfun_fill_an_array - Fill An Array By Constant Byte
 * @a:Void Pointer
 * @el: Int
 * @len:Length Int
 *Return: Void Pointer
...
if (ptr == NULL)
{
myfun_fill_an_array(result, '\0', new_size);
free(ptr);
}
else
{
